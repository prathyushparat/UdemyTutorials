...
public class BaseClass {
		...
		try {
			...
			for(int i=0;i<=totalRows;i++)
			{
				...
				if(testCaseId.equals(TCId)){
					...
					System.out.println("==== Test data is ==== "+automationTestData);
	...
	public static void setProperties(){
		try {
			FileInputStream fs = new FileInputStream("D:\\Prathyush\\Work\\Automation\\UdemyTutorial\\Ebay1\\Config\\env.properties");
